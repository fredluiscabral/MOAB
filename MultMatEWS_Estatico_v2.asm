	.file	"MultMatEWS_Estatico_v2.c"
	.text
	.p2align 4
	.type	somarMatrizes._omp_fn.0, @function
somarMatrizes._omp_fn.0:
.LFB42:
	.cfi_startproc
	endbr64
	pushq	%rbp
...
.L22:
	...
	.cfi_endproc
.LFE42:
	.size	somarMatrizes._omp_fn.0, .-somarMatrizes._omp_fn.0
	.p2align 4
	.globl	somarMatrizes
...
.LFB39:
	...
	xorl	%edx, %edx
	movq	%rsp, %rsi
	leaq	somarMatrizes._omp_fn.0(%rip), %rdi
