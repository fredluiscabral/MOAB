...
double getValue (double matriz1[TAM][TAM], int i, int j){
    return (matriz1[i][j]);
}

void setValue (double matriz1[TAM][TAM], int i, int j, double value){
    matriz1[i][j] = value;
}

void multiplicarMatrizes(double matriz1[TAM][TAM], double matriz2[TAM][TAM], double resultado[TAM][TAM], int N) {
...
*/
   ...
   double resultado[TAM][TAM];
    ...
    multiplicarMatrizes(matriz1, matriz2, resultado, N);
